...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-主著論文-nakazato-et-al-を投稿しました-非常に分解能の高い銀河形成シミュレーションを用いて遠方銀河の高い-oiii-88um-cii-158umの輝線比を説明しました",
          title: '主著論文(Nakazato et al.)を投稿しました。非常に分解能の高い銀河形成シミュレーションを用いて遠方銀河の高い[OIII]88um/[CII]158umの輝線比を説明しました。',
          description: "",
