...
<div class="caption text-center">
    ...
    ($A = L_\mathrm{E} /L_\mathrm{E,mod}$)
    as a function of gas column density 
    $N_\mathrm{H}$ and metallicity Z.
    The dashed circle represents the range of the observed values of $z > 10$ galaxies.
    We see the radiative pressure is boosted by a factor of ∼ 100 in that region.  
</div>
