...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-アメリカ自然史博物館を訪問し-セミナートークを行い-mordecai-mark-mac-low氏-eric-andersson氏と議論を行いました",
          title: 'アメリカ自然史博物館を訪問し、セミナートークを行い、Mordecai-Mark Mac Low氏、Eric Andersson氏と議論を行いました。',
          description: "",
