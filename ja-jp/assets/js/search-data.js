...
ninja.data = [{
    ...
    handler: () => {
      ...
      handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-ishigaki-alma-workshopにて招待講演を行いました",
          title: 'Ishigaki-ALMA workshopにて招待講演を行いました。',
          description: "",
          section: "News",},{id: "news-jwst-tokyo-conferenceにて口頭発表を行いました",
          title: 'JWST-Tokyo conferenceにて口頭発表を行いました。',
          description: "",
          section: "News",},{id: "news-メリーランド大学にてセミナートークを行い-共同研究者のmassimo-ricotti氏と議論を行いました",
          title: 'メリーランド大学にてセミナートークを行い、共同研究者のMassimo Ricotti氏と議論を行いました。',
          description: "",
          section: "News",},{id: "news-プリンストン大学にてセミナートークを行いました",
          title: 'プリンストン大学にてセミナートークを行いました。',
          description: "",
          section: "News",},{id: "news-マサチューセッツ大学アマースト校にてセミナートークを行い-jorge-zavala氏と議論を行いました",
          title: 'マサチューセッツ大学アマースト校にてセミナートークを行い、Jorge Zavala氏と議論を行いました。',
          description: "",
          section: "News",},{id: "news-トロント大学を訪問し-藤本征史-氏と議論を行いました",
          title: 'トロント大学を訪問し、藤本征史 氏と議論を行いました。',
          description: "",
          section: "News",},{id: "news-アリゾナ大学-スチュワード天文台を訪問し-セミナートークを行い-noirlab-yongda-zhu氏-江上-英一氏と議論しました",
          title: 'アリゾナ大学・スチュワード天文台を訪問し、セミナートークを行い(@ NOIRLab)、Yongda Zhu氏、江上 英一氏と議論しました。',
          description: "",
